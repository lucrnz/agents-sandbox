...
extern char* ParseSearchResults(char* htmlStr, int maxResults);
...
// The returned string must be freed by calling FreeString.
extern char* GetLibraryVersion(void);
